...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($kueri) {
        ...
        $pesan = pesan('danger', "Registrasi gagal. Silahkan registrasi ulang.", 1);
    }
}
...
<div class="registration-container">
    <h1 class="bold-text">Registrasi</h1>
    <?php echo $pesan; ?>
    <form method="POST">
        ...
        <div class='form-group'>
            ...
            <input id="Temail" class="form-control" type="email" name="Temail" maxlength=50 placeholder="Masukan Email"/>
        </div>
        <div class='form-group'>
